...
export default function CancelSubscriptionClient({ subscription }: { subscription: Subscription }) {
        ...
        <div className="text-center">
          ...
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-md">
            <p className="text-sm text-amber-800">
              <strong>Current subscription:</strong> ${(subscription.amountMonthly / 100).toFixed(2)}/month
            </p>
          </div>
        </div>
      </div>
